...
- We also need to make sure you have all of the required dependencies installed. To show what you have already installed, paste in the following command:
    ...
    You should see at least the following 4 entries: `ant git node node@6`. If you see `node@6` and not `node@6`, the following two commands will upgrade node@4 to node@6:
